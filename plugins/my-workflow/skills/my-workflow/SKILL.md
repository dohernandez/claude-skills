---
name: my-workflow
description: "Install curated skill tiers into any project from the marketplace. Use when user says /my-workflow."
user-invocable: true
allowed-tools:
  - Read
  - Write
...
Files to copy:
- `infra/Taskfile.dev.yaml` → `.claude/Taskfile.dev.yaml` (user-tasks only)
