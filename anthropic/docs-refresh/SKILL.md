...
- **Setup**: `/docs-refresh discover` (run once during framework setup)
...
# Generated by: /docs-refresh discover
...
Set via `/docs-refresh discover`, stored in `.claude/skills/docs-refresh.yaml`:
